...
(function() {
  var Context, StormService, fs, merge, zebraService,
  ...
  zebraService = (function(_super) {
    ...
    zebraService.prototype.processArray = function(arraykey, value) {
      var config, key, obj, valuee, _i, _len;
      config = '';
      ...
      this.configs.service.generator = (function(_this) {
        return function(callback) {
          ...
          for (key in _ref) {
            ...
            switch (typeof val) {
              case "object":
                zebraconfig += _this.processArray(key, val);
                break;
              case "number":
              case "string":
                switch (key) {
    ...
    zebraService.prototype.updateZebra = function(newconfig, callback) {
      this.data = newconfig;
